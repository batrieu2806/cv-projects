...
xmap<string, TensorDataset<double, double>*>* DSFactory::get_datasets_3cc(){
    //YOUR CODE IS HERE
    return new xmap<string, TensorDataset<double, double>*>(
        &stringHash,
        0.75, // load-factor
        0, // value-comparator: use ==, typically 0 implies use of default equality comparator
        xmap<string, TensorDataset<double, double>*>::freeValue // Custom deleter for values
    );
}
